...
const config: Config = {
  ...
  theme: {
    colors: {
      ...
      "primary-fg": ({ opacityValue }: { opacityValue: string }) =>
        `rgba(var(--primary-fg), ${opacityValue ?? 1})`,
      ...
      "fg-tertiary": ({ opacityValue }: { opacityValue: string }) =>
        `rgba(var(--fg-tertiary), ${opacityValue ?? 1})`,
      // Background
      ...
      "bg-tertiary": ({ opacityValue }: { opacityValue: string }) =>
        `rgba(var(--bg-tertiary), ${opacityValue ?? 1})`,
      ...
      "warning-fg": ({ opacityValue }: { opacityValue: string }) =>
        `rgba(var(--warning-fg), ${opacityValue ?? 1})`,
      ...
      "success-fg": ({ opacityValue }: { opacityValue: string }) =>
        `rgba(var(--success-fg), ${opacityValue ?? 1})`,
      ...
      "danger-fg": ({ opacityValue }: { opacityValue: string }) =>
        `rgba(var(--danger-fg), ${opacityValue ?? 1})`,
      // Components
